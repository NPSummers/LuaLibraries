...
local CoreGuiService = gethui and gethui() or game:GetService("CoreGui")
...
local function checkVYN() return library.UI.Parent end
...
function library:GetUsername(truename)
    return truename and Player.Name or Player.DisplayName
end
...
function library:MarchVisiblity(visible)
    tweentype = visible and 0.2 or 1
    TweenService:Create(self.March.March, TweenInfo.new(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
        ImageTransparency = tweentype
    }):Play()
end

--ADD FUNC START
function library:AddImage(Image, URL)
    local ImageFile = nil
...
function library:AddImageList(Image, URL)
    if not self.ImageList[Image] then
        self.ImageList[Image] = self:AddImage("EternalBlue/Assets/UI/"..Image..".png", URL)
    end
    return self.ImageList[Image]
end

function library:AddFolder(GetFolder)
...
function library:BootUp()
    self:AddFolder("EternalBlue")
    self:AddFolder("EternalBlue/Caches")
    self:AddFolder("EternalBlue/Assets")
    self:AddFolder("EternalBlue/Assets/UI")
    self:AddFolder("EternalBlue/Configs")
    self:AddFolder("EternalBlue/Scripts")

    self:AddImageList("Logo", "https://i.postimg.cc/CKt5xFVZ/6.png")
    self:AddImageList("March", "https://i.postimg.cc/kgHqxfYz/March.png")
end
...
function library:Msgbox(innertext, caption, style)
    ...
    local vyn = Instance.new("TextLabel")
    local vyn2 = Instance.new("TextLabel")
    local text = Instance.new("TextLabel")
    local pageLayout = Instance.new("UIListLayout")

    introduction.Name = "MSGBOX"
    ...
    edge.Size = UDim2.new(0, 300, 0, 158)
    ...
    background.Size = UDim2.new(0, 298, 0, 156)
    ...
    bar.BackgroundColor3 = Color3.fromRGB(119,172,212)
    ...
    vyn.Name = "vyn"
    vyn.Parent = background
    vyn.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    vyn.BackgroundTransparency = 1
    vyn.Size = UDim2.new(0, 300, 0, 24)
    vyn.Position = UDim2.new(0, 0, 0, 0)
    vyn.Font = Enum.Font.Code
    vyn.Text = caption or "VXLua"
    vyn.TextColor3 = Color3.fromRGB(255, 255, 255)
    vyn.TextSize = 12.000
    vyn.TextTransparency = 1

    vyn2.Name = "vyn"
    vyn2.Parent = background
    vyn2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    vyn2.BackgroundTransparency = 1
    vyn2.Size = UDim2.new(0, 300, 0, 24)
    vyn2.Position = UDim2.new(0, 0, 0.45, 0)
    vyn2.Font = Enum.Font.Code
    vyn2.Text = innertext or "VXLua"
    vyn2.TextColor3 = Color3.fromRGB(255, 255, 255)
    vyn2.TextSize = 14.000
    vyn2.TextTransparency = 1
    ...
    Buttons = {}
    function Buttons:AddButton(text, callback)
        ...
        buttonFrame.Size = UDim2.new(0, 300, 0, 24)
        ...
        button.MouseButton1Down:Connect(function()
            TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(119,172,212)}):Play()
        end)
        ...
        local function ResizeButtons()
            ...
            Resized = (300 / Amount) - AmountToSubtract
            NewSizeX = (Resized)
    ...
    wait(.2)
    TweenService:Create(vyn, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(vyn2, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)

    switch(style, { 
        [0] = function()
            local button = Buttons:AddButton("OK", function()
                returncode = 1
            end)
        end,
        [1] = function()
        ...
        [2] = function()
            local button = Buttons:AddButton("Abort", function()
                returncode = 3
            end):AddButton("Retry", function()
                returncode = 4
            end):AddButton("Ignore", function()
                returncode = 5
            end)
        end,
        [3] = function()
            local button = Buttons:AddButton("Yes", function()
                returncode = 6
        ...
        [5] = function()
            local button = Buttons:AddButton("Retry", function()
                returncode = 4
            end):AddButton("Cancel", function()
                returncode = 2
            end)
        ...
        [6] = function()
            local button = Buttons:AddButton("Cancel", function()
                returncode = 2
            end):AddButton("Try Again", function()
                returncode = 10
            end):AddButton("Continue", function()
                returncode = 11
            end)
        end
    })

    repeat task.wait() until returncode ~= 0

    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
    TweenService:Create(vyn, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
    TweenService:Create(vyn2, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
...
function library:InitNotifications(text, duration, callback)
    ...
    function Notification:Notify(text, duration, type, callback)
        ...
        elseif type == "information" then
            bar.BackgroundColor3 = Color3.fromRGB(0, 221, 255)
        end
...
function library:Introduction()
    ...
    hashLogo.Image = getcustomasset("EternalBlue/Assets/UI/Logo.png")
    hashLogo.ImageTransparency = 1
    
    vyn.Name = "vyn"
    vyn.Parent = background
    vyn.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    vyn.BackgroundTransparency = 1.000
    vyn.Size = UDim2.new(0, 80, 0, 21)
    vyn.Position = UDim2.new(0.05, 0, 0, 0)
    vyn.Font = Enum.Font.Code
    vyn.Text = "Powered by your RAM"
    vyn.TextColor3 = Color3.fromRGB(124, 124, 124)
    vyn.TextSize = 10.000
    vyn.TextTransparency = 1
    ...
    TweenService:Create(Camera, TweenInfo.new(1, Enum.EasingStyle.Quint), {FieldOfView = Camera.FieldOfView + 5}):Play()
    TweenService:Create(edge, TweenTable["introduction"], {BackgroundTransparency = 0}):Play()
    TweenService:Create(background, TweenTable["introduction"], {BackgroundTransparency = 0}):Play()
    wait(.2)
    TweenService:Create(bar, TweenTable["introduction"], {Size = UDim2.new(0, 298, 0, 1)}):Play()
    ...
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)
    TweenService:Create(Camera, TweenInfo.new(1, Enum.EasingStyle.Quint), {FieldOfView = Camera.FieldOfView - 40}):Play()
    ...
    TweenService:Create(Camera, TweenInfo.new(1, Enum.EasingStyle.Quint), {FieldOfView = Camera.FieldOfView + 35}):Play()
    for _, obj in ipairs(Lighting:GetChildren()) do
		if obj.Name == "HomeBlur" then
			TweenService:Create(obj, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Size = 0}):Play()
			task.delay(0.6, obj.Destroy, obj)
...
function library:Init(key)
    ...
    if self.SkipLoading then
        ...
        TweenService:Create(homeBlur, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Size = 5}):Play()
        TweenService:Create(Camera, TweenInfo.new(.5, Enum.EasingStyle.Quint), {FieldOfView = Camera.FieldOfView + 5}):Play()
        wait(.5)
        TweenService:Create(Camera, TweenInfo.new(.5, Enum.EasingStyle.Quint), {FieldOfView = Camera.FieldOfView - 40}):Play()
        wait(.5)
        TweenService:Create(Camera, TweenInfo.new(.5, Enum.EasingStyle.Quint), {FieldOfView = Camera.FieldOfView + 35}):Play()
        for _, obj in ipairs(Lighting:GetChildren()) do
            if obj.Name == "HomeBlur" then
                TweenService:Create(obj, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Size = 0}):Play()
                task.delay(0.6, obj.Destroy, obj)
    ...
    local introduction = Instance.new("ScreenGui")
    introduction.Name = "VYNX"
    introduction.Parent = CoreGuiService
    introduction.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    self.UI = introduction

    self.March.Parent = CoreGuiService
    local March = Instance.new("ImageLabel")
    March.Name = "March"
    March.Parent = self.March
    March.AnchorPoint = Vector2.new(0.5, 0.5)
    March.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    March.BackgroundTransparency = 1
    March.Position = UDim2.new(.8, 0, .8,0)
    March.Size = UDim2.new(0, 274, 0, 388)
    March.Visible = true
    March.Image = getcustomasset("EternalBlue/Assets/UI/March.png")
    March.ImageTransparency = 1

    library:MarchVisiblity(false)
    ...
    function TabLibrary:NewTab(title)
        ...
        page.ScrollBarImageColor3 = Color3.fromRGB(119,172,212)
        page.Visible = false
        ...
        if TabLibrary.IsFirst then
            page.Visible = true
            tabButton.TextColor3 = Color3.fromRGB(119,172,212)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(119,172,212)}):Play()
        end)
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleDesignGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(115, 234, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(69, 146, 181))}
            ...
            function ToggleFunctions:AddKeybind(default_t)
                ...
                if UserInputService.WindowFocused then
                    UserInputService.InputBegan:Connect(function(c, p)
                        if not p then
                            if c.KeyCode.Name == ChosenKey and not ChatInputBarConfiguration.IsFocused then
                                On = not On
                                local SizeOn = On and UDim2.new(0, 12, 0, 12) or UDim2.new(0, 0, 0, 0)
                                local Transparency = On and 0 or 1
                                TweenService:Create(toggleDesign, TweenTable["toggle_form"], {Size = SizeOn}):Play()
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(119,172,212)}):Play()
                end)
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            for i,v in next, list do
                ...
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(119,172,212)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(119,172,212)}):Play()
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(119,172,212)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 204, 255))}
